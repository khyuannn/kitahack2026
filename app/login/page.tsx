...
export default function LoginPage() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault();
    // For now, skip auth and navigate directly
    ...
    <div className="bg-off-white min-h-screen flex items-center justify-center p-6">
      <div className="w-full max-w-[440px] md:max-w-lg flex flex-col items-center">
        ...
        <div className="login-card w-full rounded-2xl p-8 md:p-10">
          <h2 className="text-xl font-semibold mb-8 text-center">Login to your account</h2>

          {/* Google Login */}
          <button
            onClick={handleGoogleLogin}
            className="w-full flex items-center justify-center gap-3 bg-white border border-gray-200 h-12 rounded-lg hover:bg-gray-50 transition-all duration-200 mb-6"
          >
        ...
        <div className="mt-8 text-center">
          <p className="text-sm text-gray-500">
            New to the platform?
            <a className="text-brand-accent font-semibold hover:underline ml-1" href="#">
              Create an account
            </a>
          </p>
